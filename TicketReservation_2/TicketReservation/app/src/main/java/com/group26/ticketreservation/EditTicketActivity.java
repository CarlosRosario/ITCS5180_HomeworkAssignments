...
public class EditTicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceField.setKeyListener(null);
        ...
        departureDateField.setKeyListener(null);
        departureTimeField = (EditText) findViewById(R.id.departureTimeEditText);
        departureTimeField.setKeyListener(null);
        ...
        findViewById(R.id.nameEditText).setOnClickListener(new View.OnClickListener() {
            /**
            ...
            public void onClick(View v) {
                Toast.makeText(EditTicketActivity.this,"Select ticket using SELECT button",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        findViewById(R.id.editTextSaveButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!oneWayRadioButton.isChecked()) && (nameField.getText().toString().isEmpty() || sourceField.getText().toString().isEmpty() ||
                        destinationField.getText().toString().isEmpty() || departureDateField.getText().toString().isEmpty() ||
                        departureTimeField.getText().toString().isEmpty() || returnDateField.getText().toString().isEmpty() ||
                        returnTimeField.getText().toString().isEmpty())) {
                    Toast.makeText(EditTicketActivity.this, "No fields should be empty", Toast.LENGTH_SHORT).show();
                } else if (nameField.getText().toString().isEmpty() || sourceField.getText().toString().isEmpty() ||
                        destinationField.getText().toString().isEmpty() || departureDateField.getText().toString().isEmpty() ||
                        departureTimeField.getText().toString().isEmpty()) {
                    Toast.makeText(EditTicketActivity.this, "No fields should be empty", Toast.LENGTH_SHORT).show();
                } else if (sourceField.equals(destinationField.getText().toString())) {
                    Toast.makeText(EditTicketActivity.this, "Source and Destination cannot be the same", Toast.LENGTH_SHORT).show();
                } else {
