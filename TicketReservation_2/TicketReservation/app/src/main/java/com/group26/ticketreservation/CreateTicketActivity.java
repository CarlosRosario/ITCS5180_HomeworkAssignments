    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destination.setTitle("Destination")
                .setItems(cities, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        sourceDestination = sourceEditText.getText().toString();
        ...
        findViewById(R.id.printSummaryButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roundTripButton.isChecked() && (nameEditText.getText().toString().isEmpty() || sourceEditText.getText().toString().isEmpty() ||
                        destinationEditText.getText().toString().isEmpty() || departureDate.getText().toString().isEmpty() ||
                        departureTime.getText().toString().isEmpty() || returnDate.getText().toString().isEmpty() ||
                        returnTime.getText().toString().isEmpty())) {
                    Toast.makeText(CreateTicketActivity.this, "No fields should be empty", Toast.LENGTH_SHORT).show();
                } else if (nameEditText.getText().toString().isEmpty() || sourceEditText.getText().toString().isEmpty() ||
                        destinationEditText.getText().toString().isEmpty() || departureDate.getText().toString().isEmpty() ||
                        departureTime.getText().toString().isEmpty()) {
                    Toast.makeText(CreateTicketActivity.this, "No fields should be empty", Toast.LENGTH_SHORT).show();
                } else if (sourceDestination.equals(destinationEditText.getText().toString())) {
                    Toast.makeText(CreateTicketActivity.this, "Source and Destination cannot be the same", Toast.LENGTH_SHORT).show();
                } else {
                    ticket t;
                    if (roundTripButton.isChecked()) {
